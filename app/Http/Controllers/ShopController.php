...
class ShopController extends Controller
{
    ...
    {
        $pageTitle = 'Wine Cellar Information';
        //$shops = Shop::all();
...
// resize the image to a width of 300 and constrain aspect ratio (auto height)
    ...
    {
        $shop = Auth::user()->shop;
        $pageTitle = 'Staff List for ' . $shop->name;
    ...
    {
        $pageTitle = 'Add New Cellar Staff';
