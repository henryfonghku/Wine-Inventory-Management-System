...
class RepairProductController extends Controller
{
    ...
    {
        $pageTitle = 'New Wine Reservations';
    ...
    public function trackRepairInvoicePost(Request $request){
        ...
        $invoice = Repair_invoice::where('invoice_id', $invoice_id)->with('items.product')->first();
