                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('mobile_number')? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="mobile_number" class="form-control" value="{{ old('mobile_number') }}" placeholder="Contact Number">
                        ...
                        <div class="form-group {{ $errors->has('email')? 'has-error' : '' }}">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary" required="required"><i class="fa fa-plus-square-o"></i> Add Cellar Staff</button>
                                </div>
                            </div>
