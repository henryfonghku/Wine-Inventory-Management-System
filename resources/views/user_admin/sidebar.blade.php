        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            @if(Auth::user()->isShopAdmin())
              ...
              <li class="{{ Request::is('administrator/products')? 'active' :''  }}"><a href="{{ route('all_shop_products') }}"><i class="fa fa-list"></i>  <span> View All Wine Portfolios </span> </a></li>
              ...
              <li class="treeview {{ Request::is('admin/shop/sales*')? 'active' :''  }}">
                ...
                <ul class="treeview-menu">
                  <li class="{{ Request::is('admin/shop/sales')? 'active' :''  }}">
                    <a href="{{ route('user_all_sales') }}"><i class="fa fa-list-alt"></i> View All Sales </a>
                  </li>
                  <li class="{{ Request::is('admin/shop/sales/create')? 'active' :''  }}"><a href="{{ route('user_new_sales') }}"><i class="fa fa-plus-square-o"></i>Add New Sales </a></li>
                </ul>
              </li>
              ...
              <li class="treeview {{ Request::is('admin/shop/agents*')? 'active' :''  }}">
                ...
                <ul class="treeview-menu">
                  <li class="{{ Request::is('admin/shop/agents')? 'active' :''  }}">
                    <a href="{{ route('user_agent_list') }}"><i class="fa fa-list-alt"></i> View All Staff </a>
                  </li>
                  <li class="{{ Request::is('admin/shop/agents/create')? 'active' :''  }}"><a href="{{ route('user_agent_create') }}"><i class="fa fa-plus-square-o"></i>Add New Staff </a></li>
                </ul>
              </li>
            ...
            @if(Auth::user()->isUser())
              ...
              <li class="treeview {{ Request::is('admin/repair-product*')? 'active' :''  }}">
                ...
                <ul class="treeview-menu">
                  ...
                  <li class="{{ Request::is('admin/repair-product/create')? 'active' :''  }}"><a href="{{ route('new_repair_product') }}"><i class="fa fa-plus-square-o"></i>Add New Wine Reservations </a></li>
                </ul>
              </li>
              ...
              <li class="treeview {{ Request::is('admin/stock*')? 'active' :''  }}">
                ...
                <ul class="treeview-menu">
                  <li class="{{ Request::is('admin/stock')? 'active' :''  }}"><a href="{{ route('user_stock_index') }}"><i class="fa fa-list"></i> View All Wine Inventories </a></li>
                </ul>
              </li>
