            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('shop_name')? 'has-error' : '' }}">
                        <label class="control-label  col-sm-3">Wine Cellar Name</label>
                    ...
                    <div class="form-group {{ $errors->has('shop_email')? 'has-error' : '' }}">
                        <label class="control-label  col-sm-3">Cellar Email</label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group {{ $errors->has('shop_mobile_number')? 'has-error' : '' }}">
                        <label class="control-label  col-sm-3">Cellar Contact Number</label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group {{ $errors->has('shop_address')? 'has-error' : '' }}">
                        <label class="control-label  col-sm-3">Cellar Address *</label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group">
                        <div class="col-sm-7 col-sm-offset-3">
                            <button type="submit" name="submit" class="btn btn-primary" required="required"><i class="fa fa-plus-square-o"></i> Add Wine Cellar</button>
                        </div>
                    </div>
