            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('mobile_number')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="number" name="mobile_number" class="form-control" value="{{ old('mobile_number') }}" placeholder="Contact Number">
                    ...
                    <div class="form-group {{ $errors->has('user_type')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <label><input type="radio" name="user_type" value="shop_admin" /> Cellar Admin</label>
                            <label> <input type="radio" name="user_type" value="user" /> Cellar Employee</label>
