...
<div class="login-box">
  <div class="login-logo">
    <img src="{{ asset('/images/logo.jpg')}}" alt="Deveaux's Wine" style="width:250px;height:250px;"> <br/>
    <p style = "font-family:Garamond;">
Deveraux's Wine
</p>
  </div><!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in as <br/> Administrator / Employee / Customer <br/> Please contact <a href = "mailto: henryfong@hku.hk">Henry Fong</a> if you want to create a account.</p>
