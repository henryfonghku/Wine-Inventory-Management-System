            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('shop')? 'has-error' : '' }}">
                        <label class="control-label col-sm-3">Cellar *</label>

                        <div class="col-sm-7">
                            <select class="select2 form-control" name="shop">
                                <option value="">Select Cellar</option>
                                @foreach($shops as $shop)
                                    <option value="{{ $shop->id }}" {{ $shop->id == $user->shop_id? 'selected' : '' }}>{{ $shop->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group {{ $errors->has('first_name')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                        <input type="text" name="first_name" class="form-control" value="{{ old('first_name') ? old('first_name') : $user->first_name }}" placeholder="First name">
                    ...
                    <div class="form-group {{ $errors->has('last_name')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                        <input type="text" name="last_name" class="form-control" value="{{ old('last_name') ? old('last_name') : $user->last_name }}" placeholder="Last Name" />
                    ...
                    <div class="form-group {{ $errors->has('mobile_number')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="number" name="mobile_number" class="form-control" value="{{ old('mobile_number') ? old('mobile_number') : $user->mobile }}" placeholder="Contact Number">
                    ...
                    <div class="form-group {{ $errors->has('user_type')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <label><input type="radio" name="user_type" value="shop_admin" {{ $user->user_type == 'shop_admin' ? 'checked' : '' }} /> Cellar Admin</label>
                            <label> <input type="radio" name="user_type" value="user" {{ $user->user_type == 'user' ? 'checked' : '' }} /> Cellar Employee</label>
