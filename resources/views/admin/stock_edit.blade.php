            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('unite_price')? 'has-error' : '' }}">
                        <label class="control-label col-sm-3">Unit Price (HKD)*</label>

                        <div class="col-sm-7">
                            <input type="text" name="unite_price" class="form-control" value="{{ old('unite_price') ? old('unite_price') : $stock->unite_price }}" placeholder="Product Name">
                    ...
                    <div class="form-group {{ $errors->has('total_product')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="total_product" class="form-control" value="{{ old('total_product') ? old('total_product') : $stock->total_product  }}" placeholder="Country">
                    ...
                    <div class="form-group">
                        <div class="col-sm-7 col-sm-offset-3">
                            <button type="submit" name="submit" class="btn btn-primary" required="required"><i class="fa fa-plus-square-o"></i> Edit Stock</button>
                        </div>
                    </div>
