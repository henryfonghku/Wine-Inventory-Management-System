            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('total_product')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="total_product" class="form-control" value="{{ old('total_product') }}" placeholder="Input Amount">
                    ...
                    <div class="form-group">
                        <div class="col-sm-7 col-sm-offset-3">
                            <button type="submit" name="submit" class="btn btn-primary" required="required"><i class="fa fa-plus-square-o"></i> Transfer Wine to Cellar</button>
                        </div>
                    </div>
