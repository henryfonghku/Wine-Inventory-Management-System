            ...
            <div class="col-md-12">
              ...
              <span class="small-text">
                {{ $invoice->delivery_date->format('jS M Y') }} <br>
                                                    ...
                                                    <select name="status">
                                                        <option value="waiting" {{ $invoice->status== 'waiting'? 'selected' : '' }}> Waiting for Shipment </option>
                                                        <option value="in_process" {{ $invoice->status== 'in_process'? 'selected' : '' }}> Shipping </option>
                                                        <option value="completed" {{ $invoice->status== 'completed'? 'selected' : '' }}> Shipment Completed </option>
                                                    </select>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <table class="table"  style="margin: 0">
                                        <tr>
                                            ...
                                            <address class="small-text">
                                                @if($invoice->shop) {{ $invoice->shop->name }} <br /> @endif
                            ...
                            <div class="pull-right btn-group btn-group-sm hidden-print">
                                <a href="{{ route('print_repair_invoice', $invoice->invoice_id) }}" class="btn btn-default" target="_blank"><i class="fa fa-print"></i> Print</a>
                                <a href="{{ route('pdf_repair_invoice', $invoice->invoice_id) }}" class="btn btn-default"><i class="fa fa-file-pdf-o"></i> Download</a>
                            </div>
                        </div>
