            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('unite_price')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="unite_price" class="form-control" value="{{ old('unite_price')? old('unite_price'): $product->unite_price  }}" placeholder="Unit Price (HKD)">
                    ...
                    <div class="form-group {{ $errors->has('product_model')? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="product_model" class="form-control" value="{{ old('product_model')? old('product_model'): $product->product_model  }}" placeholder="Country">
