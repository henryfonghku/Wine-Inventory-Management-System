                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->has('customer_name')? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="customer_name" id="customer_name" class="form-control" value="{{ old('customer_name') }}" placeholder="Customer Name" />
                            ...
                            <div class="form-group {{ $errors->has('customer_email')? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="customer_email" id="customer_email" class="form-control" value="{{ old('customer_email') }}"  placeholder="Customer Email"  />
                            ...
                            <div class="form-group {{ $errors->has('customer_phone')? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="customer_phone" id="customer_phone" class="form-control" value="{{ old('customer_phone') }}"  placeholder="Customer Contact"  />
                            ...
                            <div class="form-group {{ $errors->has('delivery_date')? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="delivery_date" id="delivery_date" class="form-control" value="{{ old('delivery_date') }}" placeholder="Format : yyyy-mm-dd"  />
                                    {!! $errors->has('delivery_date')? '<p class="help-block"> '.$errors->first('delivery_date').' </p>':'' !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group {{ $errors->has('special_note')? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-7">
                                    <textarea name="special_note" id="special_note" class="form-control" rows="3">{{ old('special_note') }}</textarea>
                                    <p class="help-block">Special note within 500 character, about product description or status or damage information or anything else.</p>
                                    {!! $errors->has('special_note')? '<p class="help-block"> '.$errors->first('special_note').' </p>':'' !!}
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group {{ $errors->has('repair_cost')? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="repair_cost" id="repair_cost" class="form-control" min="1" value="0" placeholder="Item Cost"/>
                                    {!! $errors->has('repair_cost')? '<p class="help-block"> '.$errors->first('repair_cost').' </p>':'' !!}
                                </div>
                            </div>
...
@section('page-js')
    ...
    <script>
        ...
        $('input[name="delivery_date"]').datepicker({format: 'yyyy-mm-dd', startDate: new Date()});
        ...
        $(function () {
            ...
            $('#addModalProductBtn').click(function(){
                ...
                var repair_cost = $('input[name="repair_cost"]').val();
                ...
                $.ajax({
                    ...
                    data : { product_qty : product_qty, product_id : product_id, repair_cost : repair_cost, _token : '{{ csrf_token() }}' },
